TRUTH = (
    ...
    "Name the song which you love the most",
    "Your favourite actor?",
    "Mention the song you most played on Spotify",
    "Tell me the Cringiest dailogues you have ever heard",
    "Give a kiss to your mom atm",
    "Hug your dad atm",
    "Do you love mr @oriksonic who is my god",
    "Mention some of your bestie name in this chat",
    "Give some truth and dare things which you like to be added in me @botsupportastra",
)
...
DARE = (
    ...
    "Do 100 squats",
    "Tell your bestie that you love him.",
    ...
    "Keep your phone off for 5 mins.",
    "What do you thinks of sex.",
    "Which is the website you are using for night trips.",
    "Type the next message with 50 letters.",
    "Join @botsupportastra at the very next moment.",
    "Add me to 5 chats as a punishment.",
    "Reduce screentime to less than 4hrs and make me a promise.",
    "Mention the admin for fun.",
)
