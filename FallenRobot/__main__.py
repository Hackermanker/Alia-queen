...
PM_START_TEXT = """
Hey👋 {}
• Me :)One of the best anime-themed telegram group management bot
...
FallenRobot_IMG = "https://telegra.ph/file/fc41fe013de74a1648669.jpg"

HELP_STRINGS = f"""
Alia's features;\n*• Take a look at all the tools*\n*🖨️ Commands can be executed using  / or !*\n*❗All doubts are welcomed @{SUPPORT_CHAT}*\n\n➲ /start : *Starts me | You've already done it.*\n• /donate : *Support the developer with an amount​.*\n• /help  : *Commands and features listing.*\n*  ‣ In pm : will send you help​ for all supported functions.*\n*  ‣ In chat : Will redirect you to pm, with the help menu.*"""

DONATE_STRING = """[rogue](https://t.me/Oriksonic)"""
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        query.message.edit_text(
            text=f"*hey,*\n  *its {dispatcher.bot.first_name}*"
            "\n*Check out the below tools ⚒️ given.*"
            "\n*written in python.*"
            f"\n\n Click on each below buttons to know more about that tool of {dispatcher.bot.first_name}.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            text="*๏ Click on the below button for more help.*"
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ,*\n\n*This is alia*\n\n*Here is my programmer :* [Github](https://github.com/Hackermanker)\n\n*ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs ɪɴ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴀɴᴅ ɴᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ʏᴇᴛ*\n*sᴏ ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ʀᴇǫᴜᴇsᴛ ᴀɴʏ ғᴇᴀᴛᴜʀᴇ, ᴩʟᴇᴀsᴇ ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ* [botsupportastra](https://t.me/botsupportastra) *ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴩᴇʀ :* [Rogue](https://t.me/Oriksonic)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
...
def get_help(update: Update, context: CallbackContext):
    ...
    if chat.type != chat.PRIVATE:
        if len(args) >= 2 and any(args[1].lower() == x for x in HELPABLE):
            ...
            return
        update.effective_message.reply_text(
            "» Tap an option for getting help menu.",
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(
                f"@{SUPPORT_CHAT}",
                "https://telegra.ph/file/c7bcf4ce33b5d79dafec0.jpg",
                caption="I am Alive!\n\nPinged since Aug;14:2022",
            )
        except Unauthorized:
            LOGGER.warning(
